    ...
    <>
      ...
      <section className="contactPage">
        ...
        <form onSubmit={handleSubmit} className="contactPage__form">
            <label htmlFor="lastname" className="contactPage__subtitle">Last Name:</label>
            <input
              type="text"
              id="lastname"
              name="lastname"
              ...
              required
            />
            <label htmlFor="firstname" className="contactPage__subtitle">First Name:</label>
            <input
              type="text"
              id="firstname"
              name="firstname"
              ...
              required
            />
            <label htmlFor="email" className="contactPage__subtitle">Email:</label>
            <input
              type="email"
              id="email"
              name="email"
              ...
              required
            />
            <label htmlFor="message" className="contactPage__subtitle">Message:</label>
            <textarea
              id="message"
              name="message"
